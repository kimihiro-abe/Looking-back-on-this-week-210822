...
//		String srcURL = request.getServletContext().getRealPath(request.getServletContext().getContextPath());
//		String passURL = srcURL.replace("\\GoGoSeach\\GoGoSeach", "\\GoGoSeach\\upload") + "/images/";
//		String imagePassURL = passURL + filename;

	//改良したpath設定方法
		ServletContext context = request.getServletContext();
		path = context.getRealPath("/upload/images/");//
