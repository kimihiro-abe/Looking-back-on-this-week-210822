...
<c:choose>
	<c:when test="${ur.accountCode == recommendAccountCode && account.accountCode == recommendAccountCode}">
	投稿者：&#x1f60e;<font color="orange" size="5" autofocus>${ur.nickName}</font>　　
	...
	<c:when test="${ur.accountCode == recommendAccountCode}">
	投稿者：&#x1f60e;<font color="orange" size="5" autofocus>${ur.nickName}</font>　　
